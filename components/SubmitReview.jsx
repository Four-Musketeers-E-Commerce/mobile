...
const SubmitReview = ({ weaponId, containerStyles, editData, onEditComplete, onCancelEdit }) => {
  ...
  return (
    <View ref={reviewRef} className={`w-full px-4 flex-col gap-4 items-center ${containerStyles}`}>
