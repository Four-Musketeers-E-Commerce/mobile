        ...
        {orders && orders.map(order => (
          ...
          >
            ...
            >
              ...
              <Text className='w-[30%] text-lg text-secondary font-psemibold'>Price</Text>
              <Text className='w-[30%] text-lg text-secondary font-psemibold'>Quantity</Text>
            </View>
            {order.weapons.map((weapon, index) => (
              <View
                ...
                className='w-full flex-row items-center justify-between'
              >
                <Text className='w-[40%] text-base font-psemibold'>{weapon.weapon_name}</Text>
                <Text className='w-[30%] text-base font-pregular'>$ {weapon.price}</Text>
                <Text className='w-[30%] text-base font-pregular'>x {order.quantities[index]}</Text>
              </View>
            ))}
          </View>
        ))}
